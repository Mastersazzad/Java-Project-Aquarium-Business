...
public class Contact extends JFrame implements ActionListener
{
	...
	public Contact(Home home,Login login)
	{
	super(" Contact us ");
	this.home=home;
	this.login=login;
	...
	public void createContactFrame(){
...
//JLabel
    JLabel l = new JLabel("Contact Information");
    l.setBounds(260,40,400,30);
	...
	l6 = new JLabel("sazzadalzaber.master@gmail.com");
    l6.setBounds(0,70,250,25);
	...
	l8 = new JLabel("https://www.facebook.com/trbaplagi");
    l8.setBounds(5,70,350,20);
...
//Image
	...
	{
		if(e.getSource()==b2 && flag1)
		{
		  this.dispose();
          home.setVisible(true);
		
		}
		else if(e.getSource()==b2 && flag2)
		{
		  this.dispose();
          home.setVisible(true);
