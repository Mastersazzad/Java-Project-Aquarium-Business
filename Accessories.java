...
public class Accessories extends JFrame implements ActionListener
{
	...
	public Accessories(Home home,Login login)
	{
		super(" Accessories ");
		this.home=home;
		this.login=login;
		flag1 = true;
		createAccessoriesFrame();
	}
	
	public Accessories(Home home)
	{
		super(" Accessories ");
		this.home=home;
		flag2 = true;
	...
	public void createAccessoriesFrame()
	{
    ...
    //JLabel	
		l2 = new JLabel("EXCLUSIVE COLLECTION -> ACCESSORIES");
		l2.setBounds(18,65,500,25);
		l2.setFont(new Font("Segoe UI",Font.BOLD,20));
		p1.add(l2);
		
		l3 = new JLabel();
		l3.setBounds(200,290,500,19);
		...
		for(int i=0; i<home.info.length; i++)
				{
					...
					if(home.info[i]!=null)
					{
						 ...
						 {
						    l3.setText(sp[0]);
							l4.setText("BDT "+sp[2]+"tk(per packet)");
