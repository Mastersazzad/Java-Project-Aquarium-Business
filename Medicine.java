...
public class Medicine extends JFrame implements ActionListener
{
	...
	public Medicine(Home home,Login login)
	{
		super(" Fish Medicine ");
		this.home=home;
		this.login=login;
	...
	public void createMedicineFrame()
	{
		...
		for(int i=0; i<home.info.length; i++)
				{
					...
					if(home.info[i]!=null)
					{
						 ...
						 {
						    l3.setText(sp[0]);
							l4.setText("BDT "+sp[2]+"tk(per bottle)");
							
						 }
						else if(sp[1].equals("10"))
						 {
						    l5.setText(sp[0]);
							l8.setText("BDT "+sp[2]+"tk(per bottle)");
							
						 }
						 else if(sp[1].equals("11"))
						 {
						    l6.setText(sp[0]);
							l9.setText("BDT "+sp[2]+"tk(per bottle)");
							
						 }
						  else if(sp[1].equals("12"))
						 {
						    l7.setText(sp[0]);
							l1.setText("BDT "+sp[2]+"tk(per bottle)");
