...
public class MTool extends JFrame implements ActionListener
{
  ...
  public MTool(Home home,Login login)
	{
		super(" Maintainence Tools ");
		this.home=home;
		this.login=login;
		flag1 = true;
		createMToolFrame();
    ...
    //JLabel	
		l2 = new JLabel("EXCLUSIVE COLLECTION -> MAINTENANCE TOOL");
		l2.setBounds(18,65,500,25);
		l2.setFont(new Font("Segoe UI",Font.BOLD,20));
		p1.add(l2);
		
		l3 = new JLabel();
		l3.setBounds(220,300,500,15);
		...
		for(int i=0; i<home.info.length; i++)
				{
					...
					if(home.info[i]!=null)
					{
						 ...
						 else if(sp[1].equals("23"))
						 {
						    l6.setText(sp[0]);
							l9.setText("BDT "+sp[2]+"tk");
							
						 }
						  else if(sp[1].equals("24"))
						 {
						    l7.setText(sp[0]);
