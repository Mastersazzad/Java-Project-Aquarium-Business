...
public class Payment extends JFrame implements ActionListener
{
	...
	public Payment(Buy b,Login login)
	{
		super(" Payment ");
		this.b=b;
		this.login=login;
     ...
     if(r1.isSelected() || r2.isSelected() || r3.isSelected() || 
		...
		if(e.getSource()==b5)
		{
			...
			if(JOptionPane.YES_OPTION==0)
			{
				...
				try
		        {
					String email = login.get_email();
					Date date = new Date();
                
				    DateFormat dateformat = new SimpleDateFormat("dd/MM/yy hh:mm");
				    String currentDate=dateformat.format(date);
					
		           String line=email+","+b.name+","+b.priceOfProduct+","+currentDate+"\n";
		           FileWriter fw=new FileWriter("All Text Files/OrderHistory.txt",true);
		           fw.write(line);
		           fw.flush();
		           fw.close();
		        }
